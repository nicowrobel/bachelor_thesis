...
the first cavities start to arise\todo{image with cavities}. The focusing Lorentz force of these cavities forms a tail at the end of the driver. The cavities still are in the linear regime. At this point another plot comes in handy to further explain the formation.
