...
\documentclass[ngerman, english, BCOR=12mm, cdgeometry=no, DIV=15, twoside, open=right]{tudscrreprt}
% European Symbols
...
\TUDoptions{cd=lightcolor,cdhead=heavy,ddcfoot=true, cdfont=true, cdmath=false}
...
\usepackage[backend=biber, style=numeric-comp, maxbibnames=12,
            ...
            sortcites=true, doi=true]{biblatex}
...
\usepackage{nicefrac}
\usepackage[unit-font-command = \mathrm]{siunitx}    % provides correct typesetting of units
