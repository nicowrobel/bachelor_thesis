...
Near light speed, the velocity of the witness bunch won't increase in a meaningful way. The witness electrons would therefor be trapped in the accelerating part of the cavity, resulting in a net increase of momentum and energy. \todo{has witness more energy than driver or what is the point?}
...
\begin{figure}
	...
	\label{fig:cycle}
\end{figure}\todo{add image (ask Richard)}
...
\todo{maybe dispersion relation and short paragraph about lehe}
